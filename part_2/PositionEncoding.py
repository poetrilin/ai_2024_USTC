...
class AddPositionEncoding(nn.Module):
    def __init__(self, d_model: int, seq_len: int, dropout_prob: float = 0):
        """
...
if __name__ == '__main__':
    ...
    pos_enc = AddPositionEncoding(embed_size, seq_len)
    print(pos_enc(inputs).shape)  # torch.Size([4, 50, 64])
